...
public class TeamMemberAction extends ToggleAction {
    ...
    @Override
    public boolean isSelected(@org.jetbrains.annotations.NotNull AnActionEvent anActionEvent) {
        return teamMemberActionPerformer.isTeamMemberSelected(teamMember);
    }

    @Override
    public void setSelected(@org.jetbrains.annotations.NotNull AnActionEvent anActionEvent, boolean b) {
        if (b) {
